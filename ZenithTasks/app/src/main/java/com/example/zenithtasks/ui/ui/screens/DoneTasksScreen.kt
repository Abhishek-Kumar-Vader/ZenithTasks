...
fun DoneTasksScreen(
    ...
    val tasksForStatus by taskViewModel.doneTasks.collectAsState()
    val filterPriority by taskViewModel.doneFilterPriority.collectAsState()
        ...
        topBar = {
            CommonTaskScreenTopAppBar(
                ...
                onFilterPrioritySelected = { priority ->
                    taskViewModel.setDoneFilterPriority(priority)
                },
                showSearchIcon = true
            )
        },
...
@Composable
fun DoneTasksScreenPreview() {
    ZenithTasksTheme {
        DoneTasksScreen(navController = rememberNavController())
    }
}